...
const NAV: NavItem[] = [
  ...
  { to: '/contact-management-pro', icon: Users,    label: 'Contact Management Pro', roles: ['ADMIN', 'SUPERVISOR'], color: COLORS.teal },
  { to: '/agents',          icon: Users,           label: 'Agents',         roles: ['ADMIN', 'MANAGER'], color: COLORS.indigo },
  { to: '/agent-management-pro', icon: Users,      label: 'Agent Management Pro', roles: ['ADMIN', 'SUPERVISOR'], color: COLORS.purple },
  ...
  { to: '/live-monitoring-advanced', icon: Globe,  label: 'Live Monitoring Plus', roles: ['ADMIN', 'SUPERVISOR'], color: COLORS.teal },
  ...
  { to: '/campaign-management-pro', icon: Layers3, label: 'Campaign Management Pro', roles: ['ADMIN', 'SUPERVISOR'], color: COLORS.teal },
  { to: '/reports-analytics-pro', icon: BarChart3, label: 'Reports Analytics Plus', roles: ['ADMIN', 'SUPERVISOR'], color: COLORS.purple },
...
const CONSOLE_GROUPS: NavGroup[] = [
  ...
  { key: 'campaigns', label: 'CAMPAIGNS', icon: Megaphone, color: COLORS.pink, roles: ['ADMIN', 'MANAGER', 'SUPERVISOR'], items: ['/campaigns', '/campaign-management-pro'] },
