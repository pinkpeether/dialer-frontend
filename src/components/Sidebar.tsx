      ...
      <aside className={`ptdt-sidebar ${mobileOpen ? 'is-open' : ''}`} style={{ width: 'var(--sidebar-width)', height: '100vh', background: 'var(--bg-glass-hi)', backdropFilter: 'blur(22px) saturate(160%)', WebkitBackdropFilter: 'blur(22px) saturate(160%)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', padding: '18px 14px', position: 'fixed', top: 0, left: 0, zIndex: 30, boxShadow: 'var(--shadow-md)', boxSizing: 'border-box', overflowX: 'hidden' }}>
        ...
        <div style={{ paddingTop: 6 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) auto', gap: 8, alignItems: 'center' }}>
            <div className="mono" title={sidebarRoleLabel(user?.role)} style={{ minHeight: 42, borderRadius: 18, border: '1px solid rgba(5,150,105,.26)', background: 'linear-gradient(145deg, #ecfff6 0%, #d7f8e7 46%, #bfeacc 100%)', color: '#047857', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 12px', fontSize: 12.2, fontWeight: 950, letterSpacing: .7, textTransform: 'uppercase', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', boxShadow: 'inset 0 1px 0 rgba(255,255,255,.85), inset 0 -1px 0 rgba(4,120,87,.08), 0 12px 28px rgba(4,120,87,.16), 0 2px 5px rgba(15,23,42,.08)' }}>
